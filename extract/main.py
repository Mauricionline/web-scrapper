...
is_well_formed_link = re.compile(r'^https?://.+/.+$')  # expresion regular https://example.com/hello
is_root_path = re.compile(r'^/.+$')  # /some-text


def _news_scraper(news_site_uid: str):
    """ mostrara en consola el mensaje"""
    articles = []
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()  # cara obtener los argumentos extras en este caso los tiempos

    new_site_choices = list(config()['news_sites'].keys())  # obteniendo las llaves del yaml en forma de lista
